...
with open('subj.json', 'w', encoding='utf-8') as init_f:
    json.dump(subj, init_f)

subj = {}
with open('file_06.txt', 'r', encoding='utf-8') as init_f:
    for line in init_f:
        subject, lecture, practice, lab = line.split()
        subj[subject] = int(lecture) + int(practice) + int(lab)
    print(f'Общее количество часов по предмету - \n {subj}')

# в конце что-то пошло нетак, но времени уже не было
